    ...
    <main>
        ...
        ?>
            <div class="container my-5 p-5">
                <div class="row"> 
                    <section  class="col-xs-12 col-sm-12 col-md-12 col-lg-12 my-5">
                            ...
                            <tbody>
                                <?php foreach($voyages as $voyage):?>
                                    <tr>
                                        ...
                                        <td><input name="dateVoyage" type="date"></td>
                                        <td><input name="nbrBillets" type="number"></td>
                                            <input hidden
                                                   name="voyageCode" 
                                                   type="text" 
                                                   value="<?php echo $voyage['codeVoyage'] ?>">
                                            <td>
